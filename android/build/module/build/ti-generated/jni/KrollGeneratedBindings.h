	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.marcbender.emitterview.ViewProxy", ::de::marcbender::emitterview::tiview::ViewProxy::bindProxy, ::de::marcbender::emitterview::tiview::ViewProxy::dispose},
				{"de.marcbender.emitterview.TiEmitterViewModule", ::de::marcbender::emitterview::TiEmitterViewModule::bindProxy, ::de::marcbender::emitterview::TiEmitterViewModule::dispose}
			};
